...
const Menu = () => {
  ...
  return (
    <div>
      {!open ? (
        <Image src="/open.png" alt="" className="w-auto h-auto" priority width={20} height={20} onClick={() => setOpen(true)}/>
      ) : (
        <Image src="/close.png" alt="" className="w-auto h-auto" priority width={20} height={20} onClick={() => setOpen(false)}/>
      )}
      {open && (
