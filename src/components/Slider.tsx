...
const Slider = () => {
    ...
    return (
        ...
        <div className="flex-1 flex items-center justify-center flex-col gap-8 text-orange-500 font-bold">
            ...
            <button className="bg-orange-500 text-white py-4 px-8 rounded-lg">Order Now</button>
        </div>
        {/* IMAGE CONTAINER */}
        <div className="w-full flex-1 relative">
            <Image src={data[currentSlide].image} alt="" fill sizes="100%" className="object-cover" priority/>
        </div>
        </div>
    )
}
